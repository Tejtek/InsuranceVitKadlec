    ...
    public partial class Create_tables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsuredesInsurences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InsuredesInsurences_Insured_InsuredId",
                        column: x => x.InsuredId,
                        principalTable: "Insured",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InsuredesInsurences_Insurence_InsurenceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuredesInsurences_InsuredId",
                table: "InsuredesInsurences",
                column: "InsuredId");

            migrationBuilder.CreateIndex(
                name: "IX_InsuredesInsurences_InsurenceId",
                table: "InsuredesInsurences",
                column: "InsurenceId");
        }
